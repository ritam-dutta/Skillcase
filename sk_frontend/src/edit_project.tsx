...
<div className="h-[13vh] w-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-start px-6 sm:px-8">
    <h1 className="text-2xl sm:text-3xl text-white font-bold mt-6 ">Edit Project</h1>
</div>
            ...
            <form className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between gap-6">
                    <button
                        ...
                        className="w-full sm:w-auto bg-gray-400 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    >
                        Cancel Changes
                    </button>
                    <button
                        ...
                        className="w-full sm:w-auto bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    >
                        Save Changes
                    </button>
                </div>
