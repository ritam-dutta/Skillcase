...
const UploadProject: React.FC<UploadProject> = () => {
  ...
  return (
    <>
    <body className="bg-[url('/images/background.jpg')] bg-cover bg-center min-h-screen flex flex-col">
    <Header />
    ...
    <div className="flex items-center justify-center flex-grow px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-3xl bg-slate-50 rounded-lg shadow-lg p-6 sm:p-8 lg:mt-[-11vh] mt-0 overflow-auto">
