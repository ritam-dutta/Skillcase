...
const ViewProjects : React.FC<ViewProjects> = ({})=>{
  ...
  return(
    ...
    <div className="min-h-screen w-full bg-gray-300 dark:bg-gray-600">
        ...
        <div className="lg:h-[18vh] sm:h-[10vh] w-full bg-gradient-to-r from-blue-500 to-indigo-500 dark:from-blue-800 dark:to-slate-900 flex items-center px-8">
            <h1 className="text-3xl text-white dark:text-gray-100 font-bold">My Projects</h1>
        </div>

        <div className="flex flex-col md:flex-row justify-center lg:mt-[-10vh] md:mt-4 sm:mt-4 px-4 md:px-0">
        
            {!loading ? (
            <div className="w-full md:w-[65%] h-auto bg-slate-50 dark:bg-slate-900 dark:border-gray-600 shadow-lg rounded-lg p-8 border  overflow-auto">
            <h2 className="text-2xl font-bold mb-4 dark:text-gray-200">Projects Status</h2>

            {/* Stats Cards */}

            {loggedInRole === "client" ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div className="bg-gray-200 dark:bg-slate-800 dark:border-gray-600 p-4 shadow-sm border border-gray-200 rounded-lg w-full flex justify-center items-center">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">Completed: {completed}</h3>
                    </div>
                    <div className="bg-gray-200 dark:bg-slate-800 dark:border-gray-600 p-4 shadow-sm border border-gray-200 rounded-lg w-full flex justify-center items-center">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">In Progress: {inProgress}</h3>
                    </div>
                    <div className="bg-gray-200 dark:bg-slate-800 dark:border-gray-600 p-4 shadow-sm border border-gray-200 rounded-lg w-full flex justify-center items-center">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">Not Started: {notStarted}</h3>
                    </div>
                    <div className="bg-gray-200 dark:bg-slate-800 dark:border-gray-600 p-4 shadow-sm border border-gray-200 rounded-lg w-full flex justify-center items-center">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">On Hold: {onHold}</h3>
                    </div>
                    <div className="bg-gray-200 dark:bg-slate-800 dark:border-gray-600 p-4 shadow-sm border border-gray-200 rounded-lg w-full flex justify-center items-center">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">Cancelled: {cancelled}</h3>
                    </div>
                    <div className="bg-gray-200 dark:bg-slate-800 dark:border-gray-600 p-4 shadow-sm border border-gray-200 rounded-lg w-full flex justify-center items-center">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">Total: {total}</h3>
                    </div>
                </div>)
            :(
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <h2 className="text-xl font-semibold mb-3 text-black dark:text-gray-200">Completed Projects</h2>
                <div className="mb-8 overflow-auto bg-gray-200 dark:bg-slate-800 dark:border-slate-600 px-4 py-6 rounded-lg border border-gray-200">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {completedProjects.length > 0 ? (
                        completedProjects.map((project : Project) => (
                        <div
                            key={project._id}
                            className="bg-slate-50 border border-gray-200 dark:bg-slate-900 dark:border-gray-600 shadow-md rounded-lg p-4 hover:shadow-lg transition"
                        >
                            <div className="w-full flex justify-between items-end">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-200 mt-1 truncate">
                        ...
                        <div className="col-span-full bg-gray-200 dark:bg-slate-800 rounded-lg flex items-center justify-center">
                ...
                {userType==="client" ? (
                    <div>
                        <h2 className="text-xl font-semibold mb-3 text-black dark:text-gray-200">Not Started Projects</h2>
                        <div className="mb-8 overflow-auto bg-gray-200 dark:bg-slate-800 dark:border-slate-600 px-4 py-6 rounded-lg border border-gray-200">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                notStartedProjects.map((project : Project) => (
                                    <div
                                        key={project._id}
                                        className="bg-slate-50 dark:bg-slate-900 dark:border-gray-600 border border-gray-200 shadow-md rounded-lg p-4 hover:shadow-lg transition"
                                    >
                                        <div className="w-full flex justify-between items-end">
                                            <div>
                                                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 truncate">
                                                ...
                                                <p className="text-sm text-gray-600 mt-1 dark:text-gray-200 truncate">
                                                    {(project.description.length > 15 ? project.description.slice(0,15)+"..." : project.description) || "No description provided."}
                                                </p>
                                            </div>
                                            <div>
        ...
        <div className="mb-8 overflow-auto bg-gray-200 dark:bg-slate-800 dark:border-gray-600 px-4 py-6 rounded-lg border border-gray-200">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div
                        ...
                        <div className="w-full flex justify-between items-end">
                            ...
                            <div className="flex flex-col">
                                ...
                                <button
                                    className="flex justify-center items-center bg-red-700 text-white h-5 w-5 rounded-full hover:text-white hover:bg-red-400 transition"
         ...
         {userType === "client"? (
        <div>
            <h2 className="text-xl font-semibold mb-3 text-black dark:text-gray-200">Projects On Hold</h2>
            <div className="mb-8 overflow-auto bg-gray-200 dark:bg-slate-800 dark:border-gray-600 px-4 py-6 rounded-lg border border-gray-200">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <h2 className="text-xl font-semibold mb-3 text-black dark:text-gray-200"> Cancelled Progress</h2>
            <div className="mb-8 overflow-auto bg-gray-200 dark:bg-slate-800 dark:border-gray-600 px-4 py-6 rounded-lg border border-gray-200">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      :(
        <div className="w-full md:w-[60vw] h-auto flex flex-col justify-center items-start bg-slate-50 dark:bg-slate-800 rounded-md shadow-lg p-6 space-y-4">
