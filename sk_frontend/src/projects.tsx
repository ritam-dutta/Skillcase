...
const ProjectPage: React.FC<ProjectPage> = ({}) => {
  ...
  ? "h-full flex flex-col items-center text-[#1e3a8a] bg-[url('/images/background.jpg')] bg-cover bg-center" 
  : "min-h-screen sm:h-auto flex flex-col items-center text-[#1e3a8a] bg-[url('/images/background.jpg')] bg-cover bg-center"}>
    ...
    <main className="flex-grow w-[90%] max-w-[1200px] py-10">
        ...
        {!loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 bg-slate-200 p-8 rounded-md overflow-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 bg-slate-50 p-8 rounded-md overflow-auto">
