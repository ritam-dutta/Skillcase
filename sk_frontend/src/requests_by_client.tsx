...
<div className="h-[85vh] w-screen bg-[url('/images/background.jpg')] bg-cover bg-center flex flex-col justify-between">
    ...
    <main className="h-[72vh] flex-grow w-full flex justify-center items-start py-6">
        {!loading ? (
        <div className="w-11/12 sm:w-10/12 md:w-3/4 lg:w-1/2 bg-slate-50 shadow-lg rounded-lg p-8 lg:mt-[-13vh]">
            {/* Form Content */}
                        ...
                        applications.map((application, index) => (
                            <div key={index} className="flex items-center justify-between bg-slate-100 p-4 shadow-md rounded-md">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm sm:text-base">Collaboration request for project has been sent to</p>
                                        <Link to={`/client/profile/${application.client}`} className="text-sm sm:text-base text-blue-600">
                                            @{application.client}!
                                        </Link>
                                    </div>
                                </div>
