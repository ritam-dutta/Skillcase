  ...
  return(
    <>
      ...
      <div className="flex flex-row justify-center mt-[-10vh]">
        ...
        <div className="w-[25%] h-[90vh] bg-white shadow-lg rounded-lg p-6 flex flex-col items-center border border-gray-200">
        ...
        <div className="w-[65%] bg-white shadow-lg rounded-lg p-8 ml-6 border border-gray-200">
          ...
          {/* Pending Projects */}
        <h2 className="text-xl font-semibold mb-3 text-blue-700">Pending Projects</h2>
        <div className="mb-8 overflow-auto bg-gray-100 h-[40vh] px-4 py-6 rounded-lg border border-gray-200">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="col-span-full bg-gray-100 h-40 rounded-lg flex items-center justify-center border border-gray-200">
                <p className="text-gray-600">No pending projects available</p>
            </div>
            )}
        </div>
        </div>
